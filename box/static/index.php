...
<head>
    ...
    <script type="text/javascript" src="<?php bloginfo('template_url');?>/js/marquee.js"></script>
...
<body>
            ...
            <div class="header-top-search">
                <form method="get" id="searchform" action="<?php bloginfo('home'); ?>/"> 
                    <input name="s" type="text" id="s" class="inputbox" /> 
                     <input style="margin-bottom:-6px;" type="image" src="box/themes/tutear/images/ss.jpg" name="Submit" value="提交">
                </form>
            </div>
            <ul class="top-nav">
            <li>旗下媒体 |</li>
    ...
    <div class="wrap content">
                ...
                <ul class="pan-body">
                    <li class="first">
                        <a class="img-wrap" href="#">
                            <img src="box/themes/tutear/images/shili.jpg" />
                        </a>
                        <a href="">不知名茶</a>
                    </li>
                    <li>
        ...
        <div class="sider">
            <div class="pan video">
                <div class="pan-body">
                <img class="video-img" src="box/themes/tutear/images/test.jpg" alt="" />
